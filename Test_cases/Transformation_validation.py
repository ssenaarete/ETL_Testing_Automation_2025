...
class TransformationValidation:
    ...
    def run(self):
        ...
        # Save report
        report_file = self.report_helper.save_report(results, test_type="Transformation_Logic_check")
        print(f"DEBUG: report_file returned = {report_file}")
        self.report_helper.print_validation_report_Transformation_logic(results)
...
if __name__ == "__main__":
    atv = TransformationValidation("config.ini")
    atv.run()
